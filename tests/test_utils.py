...
def test_not_group_sections_with_coreqs():
    ...
    data = {
        ...
        'Coreq_Sections': [None, None, 'ESL-116-101'], # One section has a corequisite and should NOT be grouped with others
...
def test_group_same_course():
    ...
    data = {
        ...
        'Name': ['ENG-103-101', 'ENG-103-102', 'CHE-171-101'], # One section belongs to a different course and should not be grouped with others
        'STime': ['08:00 AM', '08:00 AM', '08:00 AM'],
        'ETime': ['09:00 AM', '09:00 AM', '09:00 AM'],
        'SDate': ['2024-01-01 00:00:00', '2024-01-01 00:00:00', '2024-01-01 00:00:00'],
        'EDate': ['2024-05-01 00:00:00', '2024-05-01 00:00:00', '2024-05-01 00:00:00'],
...
def test_group_same_dates():
    ...
    data = {
        ...
        'Duration': ['Full Semester', 'Full Semester', '1st Half', '2nd Half'] # Different durations
    }
    df = pd.DataFrame(data)
...
def test_parse_date():
    ...
    assert parse_date('2024-01-01 08:00:00') == datetime(2024, 1, 1, 8, 0, 0), "Parsed date should be 2024-01-01 08:00:00"
...
def test_has_time_conflict():
    ...
    assert has_time_conflict(sections) is False, "There should be no conflict among the sample sections"
...
def test_sort_combination():
    ...
    data = {
        ...
        'Method': ['LEC', 'LEC', 'LEC', 'ONLIN', 'INTRN']  # Two sections have no meeting times or dates (should be listed last)
    }
    df = pd.DataFrame(data)
...
def test_print_summary(capsys):
    ...
    scored_combinations = [
        (
            [
                {'Name': 'BIO-151-101', 'Mtg_Days': 'M, W, F', 'STime': '08:00 AM', 'ETime': '09:00 AM', 'Method': 'LEC'},
                {'Name': 'CHE-171-102', 'Mtg_Days': 'M, W, F', 'STime': '08:00 AM', 'ETime': '09:00 AM', 'Method': 'LEC'}
            ],
            {'score': 1}
        ),
        (
            [
                {'Name': 'CHE-171-101', 'Mtg_Days': 'T, TH', 'STime': '10:00 AM', 'ETime': '11:00 AM', 'Method': 'LEC'},
                {'Name': 'CHE-151-102', 'Mtg_Days': 'T, TH', 'STime': '10:00 AM', 'ETime': '11:00 AM', 'Method': 'LEC'}
            ],
            {'score': 2}
        )
    ]

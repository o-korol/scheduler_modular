...
config = {
    "weights": {
        ...
        "availability": 5  # Keep this weight high if availability is NOT flexible
    },
    ...
    "gap_weights": {
        ...
        "max_allowed_gap": 20, # In minutes # Consider renaming to include units in the name
    ...
    "availability": {
        "time_out_of_bounds": 60,  # Time interval to check out-of-bounds, in minutes (1 hour)
        "penalty_per_hour": 1  # Penalty for every hour out of bounds
    }
}
